...
export const WordleMissionModal: React.FC<WordleMissionModalProps> = ({ question, placeUrl, bonusPoints, onHome, onSubmit }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 px-6" onClick={(e) => e.stopPropagation()}>
            <div className="bg-white rounded-[24px] p-8 max-w-[400px] w-full relative" onClick={(e) => e.stopPropagation()}>
